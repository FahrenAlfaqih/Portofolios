    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-b border-gray-700">
          ...
          <h2 classNafme="text-xl font-bold text-white">Fahren Alfaqih</h2>
        ...
        <nav className="flex-1 px-4 py-6">
          ...
          >
            ...
            <span className="group-hover:text-white-400 transition">
              Experiences
            </span>
          </a>
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex justify-center space-x-4">
            <a
              href="https://github.com/fahrenalfaqih"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white-400 transition"
            >
            ...
            <a
              href="https://linkedin.com/in/fahren-alfaqih"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white-400 transition"
            >
            ...
            <a
              href="https://instagram.com/fahrenalfaqih"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M7.75 2C4.575 2 2 4.575 2 7.75v8.5C2 19.425 4.575 22 7.75 22h8.5C19.425 22 22 19.425 22 16.25v-8.5C22 4.575 19.425 2 16.25 2h-8.5zm0 2h8.5C18.007 4 20 5.993 20 7.75v8.5C20 18.007 18.007 20 16.25 20h-8.5C5.993 20 4 18.007 4 16.25v-8.5C4 5.993 5.993 4 7.75 4zm4.25 3.5a4.75 4.75 0 100 9.5 4.75 4.75 0 000-9.5zm0 2a2.75 2.75 0 110 5.5 2.75 2.75 0 010-5.5zm4.75-.75a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5z" />
              </svg>
            </a>
          </div>
        </div>
